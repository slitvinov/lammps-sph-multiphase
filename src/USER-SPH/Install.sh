...
if (test $1 = 1) then
  ...
  cp -p pair_sph_heatconduction_phasechange.cpp ..
  ...
  cp -p pair_sph_heatconduction_phasechange.h ..
  ...
  rm -f ../pair_sph_heatconduction_phasechange.cpp
  ...
  rm -f ../pair_sph_heatconduction_phasechange.h
